...
#namespace("user")
  ...
  #end
  #sql("searchUser_a")
	from system_user a,system_role_user b,system_role c where a.user_id = b.user_id and b.role_id = c.role_id and c.state='1' and a.user_name like ? group by a.user_id,a.user_name,a.nick_name,a.`password`,a.state,a.introduction,a.avatar,a.create_time order by a.user_id
  #end
  #sql("searchUser_b")
	from system_user a,system_role_user b,system_role c where a.user_id = b.user_id and b.role_id = c.role_id and c.state='1' and a.nick_name like ? group by a.user_id,a.user_name,a.nick_name,a.`password`,a.state,a.introduction,a.avatar,a.create_time order by a.user_id
  #end
  #sql("searchUser_c")
	from system_user a,system_role_user b,system_role c where a.user_id = b.user_id and b.role_id = c.role_id and c.state='1' and c.role_name like ? group by a.user_id,a.user_name,a.nick_name,a.`password`,a.state,a.introduction,a.avatar,a.create_time order by a.user_id
  #end
